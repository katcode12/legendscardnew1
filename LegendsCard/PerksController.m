...
-(void)fetchEntries
{
    ...
    else if([school isEqualToString:@"florida"]){
        NSURL *url4 = [NSURL URLWithString:@"http://legendscard.com/images/iphoneapp/UF.xml"];
        NSURLRequest *req4 = [NSURLRequest requestWithURL:url4];
        connection = [[NSURLConnection alloc] initWithRequest:req4 delegate:self startImmediately:YES];
    }
